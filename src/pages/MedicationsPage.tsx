    ...
    if (!isLoading) {
      if (!isAuthenticated) {
        toast({
          ...
          description: "Please log in to access medication management.",
          variant: "destructive",
        });
        navigate('/login');
      } else {
      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <main className="flex-grow container mx-auto px-4 py-8 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-2">Loading medication management...</p>
          </div>
        </main>
        <Footer />
      </div>
        ...
        <main className="flex-grow container mx-auto px-4 py-8 flex items-center justify-center">
          <div className="text-center bg-red-50 p-6 rounded-lg border border-red-200 max-w-md">
            ...
            <p className="text-sm text-red-700 mb-4">
              Please log in to access medication management.
            </p>
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Pill className="h-6 w-6 text-medivault-600 mr-2" />
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <MedicationManager refreshTrigger={refreshTrigger} />
        </div>
      </main>
